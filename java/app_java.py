...
@st.cache_resource
def load_model():
    tokenizer = AutoTokenizer.from_pretrained("/Users/unknown1/Desktop/Auto_Comments/java/model/trained-code-comment-model")
    model = AutoModelForSeq2SeqLM.from_pretrained("/Users/unknown1/Desktop/Auto_Comments/java/model/trained-code-comment-model")
